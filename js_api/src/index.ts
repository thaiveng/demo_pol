...
async function connect(nodes: string[]) {
  ...
  return new Promise( async (resolve, reject) => {
    ...
    console.log("wsProvider.isReady", wsProvider.isReady);
    console.log("wsProvider.isConnected", wsProvider.isConnected);
    try {
      ...
      (<any>window).api = res;
      console.log("res.isReady", res.isReady);
      ...
      // console.log("hello log", `${url} wss connected success`);
      // resolve(url);
    } catch (err) {
